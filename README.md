...
### 📌 Global Data Career Salaries Dashboard (Excel)
- Analyzed global salary data to identify trends, patterns, and disparities across countries  
- Built an interactive dashboard using Pivot Tables, slicers, and map visualizations  
- Explored salary trends by role, experience level, and work arrangement  

### 📌 Superstore Sales & Profit Analysis (Excel)
- Analyzed sales and profit trends using Pivot Tables  
- Examined product performance across customer segments  
- Evaluated the impact of discounts on profitability  

### 📌 Sales Data Analysis (Python)
- Performed descriptive statistical analysis on sales data  
- Analyzed distribution, correlation, and variability of data  
- Applied z-score to identify patterns and outliers  
